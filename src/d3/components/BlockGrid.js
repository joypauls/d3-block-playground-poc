// Renders a grid of blocks, optionally interactive, with provided state of block visibility
// Either a full grid of blocks that can be interacted with, or a grid of blocks with a subset of blocks visible
